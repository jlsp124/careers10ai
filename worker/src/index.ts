...
function generateGptPrompt(
  ...
  return [
    ...
    "- Do not use memories or personal assumptions.",
    "- Use only provided files and request details.",
    "- Do not invent personal experiences.",
    "- Ask for missing info if needed.",
    "- If safe assumptions are used, state them.",
    "- Keep the work appropriate for Grade 10 careers class.",
    "- Include a Student Review Notes section.",
    "",
    "Request details:",
